...
class Prediction(KnowledgeEngine):
    ...
    def predictAAPL(self):
        ...
        overallSentimentSubjectivity = finalTotalSubjectivity/5    
        # print ("Overall Sentiment Subjectivity: ", overallSentimentSubjectivity)

        returnValues.append(finalTotalPolarity)
        returnValues.append(overallSentimentSubjectivity)
    ...
    def predictAMZN(self):
        ...
        # print ("Calculating final score to predict if stock price would go up or down")
        # print ("Combined Sentiment Polarity: ", finalTotalPolarity)
        overallSentimentSubjectivity = finalTotalSubjectivity/4
        # print ("Overall Sentiment Subjectivity: ", overallSentimentSubjectivity)
    ...
    def query(self,factname):
        ...
        # print ("Calculating final score to predict if stock price would go up or down")
        # print ("Combined Sentiment Polarity: ", finalTotalPolarity)
        overallSentimentSubjectivity = finalTotalSubjectivity/3    
        # print ("Overall Sentiment Subjectivity: ", overallSentimentSubjectivity)
